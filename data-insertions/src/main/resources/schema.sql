...
(
    user_id           INT REFERENCES users (user_id),
    social_media_name VARCHAR(50)  NOT NULL CHECK (social_media_name IN
...
VALUES (1, 3), -- Student role can enroll_student
...
(
    ...
    activity_type        VARCHAR(50) DEFAULT 'profile_update' CHECK (activity_type IN
                                                                     ('login', 'logout', 'profile_update',
                                                                      'password_change', 'email_verification',
                                                                      'phone_verification', 'role_update',
                                                                      'course_enrollment', 'course_completion',
                                                                      'event_registration', 'event_participation',
                                                                      'social_media_link'))
);
