...
import com.bugbusters.course.kafka_models.DeleteAdminRequest;
import com.bugbusters.course.kafka_models.DeleteResult;
...
public class CourseController {
    ...
    public CourseController(CourseService courseService, CommandDispatcher commandDispatcher) {
    ...
    @GetMapping("/test")
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<?> test() throws MessageQueueException {
        this.commandDispatcher.sendCommand(
