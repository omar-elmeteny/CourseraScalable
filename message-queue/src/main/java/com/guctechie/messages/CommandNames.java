package com.guctechie.messages;
...
public class CommandNames {
    ...
    public static final String DELETE_PROFILE_BY_ID = "delete-profile-by-id";
    public static final String DELETE_PROFILE_BY_USER_ID = "delete-profile-by-user-id";
    public static final String FILTER_PROFILES = "filter-profiles";
