...
import com.bugbusters.contentservice.messages.configs.WebServerConfig;
...
public class MessageQueueCommandDispatcher implements CommandDispatcher {
    ...
    @Override
    public <TRequest, TResponse> TResponse sendCommand(String commandName, TRequest request,
            Class<TResponse> responseType) throws MessageQueueException {
        ...
        try {
            CommandResponseMessage responseMessage = future.get(messageQueueConfig.getCommandTimeoutMillis(),
    ...
    private void start() {
        synchronized (this) {
            ...
            messageConsumerUnsubscriber = messageConsumer.subscribe(webServerConfig.getResponseTopic(),
